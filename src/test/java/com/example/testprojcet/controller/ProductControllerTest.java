...
// 간결한 테스트 코드 작성을 위해 static import를 사용함
...
import com.example.testprojcet.service.impl.ProductServiceImpl;
...
//@AutoConfigureWebMvc // MockMvc를 Builder 없이 주입받을 수 있게 함
public class ProductControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @MockBean // Mock객체(테스트용 Bean)를 생성해줌
    ...
    void getProductTest() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.productId").exists()) // json의 키 값을 검색 가능
    ...
    void createProductTest() throws Exception {
        ...
        // Mock 객체에 해당 값(ProductDTO)을 넣어줌
        given(productService.saveProduct("15871", "pen", 5000, 2000)).willReturn(
                new ProductDTO("15871", "pen", 5000, 2000)); //

        // given에 세팅한 값과 일치해야 test 성공. 값이 다를 경우 test 실패
